...
from .views import (
    ...
    TrashedTestimonialRestoreAPIView, TrashedXpertListAPIView, TrashedXpertRestoreAPIView
)
...
urlpatterns = [
     ...
     path('testimonial-trash', TrashedTestimonialListAPIView.as_view(), name="testimonial_trash"),
     path('testimonial-trash-restore/<int:pk>', TrashedTestimonialRestoreAPIView.as_view(), name="testimonial_trash_restore"),
     ...
     path('tech-star-trash', TrashedTechStarListAPIView.as_view(), name="tech_star_trash"),
     path('tech-star-trash-restore/<int:pk>', TrashedTechStarRestoreAPIView.as_view(), name="tech_star_trash_restore"),
     ...
     path('xpert-trash-restore/<int:pk>', TrashedXpertRestoreAPIView.as_view(), name="xpert_trash_restore"),
