...
urlpatterns = [
     ...
     path('trash-blog-restore/<int:pk>', TrashedBlogRestoreAPIView.as_view(), name='trash_blog_restore'),
     ...
     path('trash-comment-restore/<int:pk>', TrashedCommentRestoreAPIView.as_view(), name='trash_comment_restore'),
    ...
    #     path('comment/<int:pk>', CommentDetailsUpdateDeleteAPIView.as_view(), name='comment_detail_update_delete'),
     ...
     path('trash-author-restore/<int:pk>', TrashedAuthorRestoreAPIView.as_view(), name='trash_author_restore'),
     ...
     path('trash-news-restore/<int:pk>', TrashedNewsRestoreAPIView.as_view(), name='trash_news_restore'),
    ...
    #
     ...
     path("images-trash-restore/<int:pk>", TrashedImageRestoreAPIView.as_view(), name="images_trash-restore"),
