...
app_name = 'Blogs'
urlpatterns = [
     path('blogs', views.BlogArticleListCreateAPIView.as_view(), name="blog_list_create"),
     path('blogs/<int:pk>', views.BlogArticleRetrieveUpdateDeleteAPIView.as_view(), name="blog_detail_update"),
     # path('blog-delete/<int:pk>', views.blog_delete, name='blog_delete'),
     path('<int:pk>/comments', views.CommentListCreateAPIView.as_view(),name="comment_list_create"),
     path('<int:blog_pk>/comment-delete/<int:pk>', views.comment_delete, name='comment_delete'),
     path('tag', views.TagListCreateAPIView.as_view(), name='Tag-list'),
     ...
     path('news', views.NewsArticleListCreateAPIView.as_view(), name="news_list_create"),
     path('news/<int:pk>', views.NewsArticleRetrieveUpdateDeleteAPIView.as_view(), name='news_detail_update'),
